...
const Trash = () => {
  ...
  const deleteAllClick = () => {
    setType("deleteAll");
    setMsg("Вы действительно хотите навсегда удалить все записи?");
    setOpenDialog(true);
  };

  const restoreAllClick = () => {
    setType("restoreAll");
    setMsg("Вы действительно хотите восстановить все записи в корзине?");
    setOpenDialog(true);
  };
  ...
  const restoreClick = (id) => {
    setSelected(id);
    setType("restore");
    setMsg("Вы действительно хотите восстановить выбранную запись?");
    setOpenDialog(true);
  };
  ...
  const TableHeader = () => (
    <thead className="border-b border-gray-300">
      <tr className="text-black  text-left">
        ...
        <th className="py-2 line-clamp-1">Изменено</th>
      </tr>
    </thead>
  );
