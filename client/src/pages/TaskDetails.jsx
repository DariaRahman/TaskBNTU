...
const bgColor = {
  "высокий": "bg-red-200",
  "средний": "bg-yellow-200",
  "низкий": "bg-blue-200",
};

const TABS = [
  { title: "Подробнее", icon: <FaTasks /> },
  { title: "Комментарии/хронология", icon: <RxActivityLog /> },
];
            ...
            <div className="w-full flex flex-col md:flex-row gap-5 2xl:gap-8 bg-white shadow-md p-8 overflow-y-auto">
              ...
              <div className="w-full md:w-1/2 space-y-8">
                ...
                <p className="text-gray-500">
                  Дата сдачи: {new Date(task?.date).toLocaleDateString()}
                </p>

                <div className="flex items-center gap-8 p-4 border-y border-gray-200">
                  <div className="space-x-2">
                    <span className="font-semibold">Вложений :</span>
  ...
  return (
    <div className="w-full flex gap-10 2xl:gap-20 min-h-screen px-10 py-8 bg-white shadow rounded-md justify-between overflow-y-auto">
      <div className="w-full md:w-1/2">
        <h4 className="text-gray-600 font-semibold text-lg mb-5">Комментарии</h4>
